...
#define rcS1 ((VIDEOINFOHEADER2*)(pmt->pbFormat))->rcSource
#define rcT1 ((VIDEOINFOHEADER2*)(pmt->pbFormat))->rcTarget
...
#define rcS ((VIDEOINFOHEADER2*)(pmtOut->pbFormat))->rcSource
#define rcT ((VIDEOINFOHEADER2*)(pmtOut->pbFormat))->rcTarget
