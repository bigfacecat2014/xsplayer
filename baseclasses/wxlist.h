...
// File: WXList.h
//
// Desc: DirectShow base classes - defines a non-MFC generic template list class.
// Win eXtended List
//
...
public:
    ...
    class CNode {
        ...
        CNode *m_pPrev = nullptr;         /* Previous node in the list */
        CNode *m_pNext = nullptr;         /* Next node in the list */
        void *m_pObject = nullptr;      /* Pointer to the object */
