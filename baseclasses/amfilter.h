...
protected:
    ...
    WCHAR* m_pName = nullptr; // This pin's name
    IPin* m_Connected = nullptr; // Pin we have connected to
    PIN_DIRECTION m_dir; // Direction of this pin
    CCritSec* m_pLock = nullptr; // Object we use for locking
    bool m_bRunTimeError; // Run time error generated
    bool m_bCanReconnectWhenActive; // OK to reconnect when active
    bool m_bTryMyTypesFirst; // When connecting enumerate
                                                // this pin's types first
    CBaseFilter* m_pFilter = nullptr; // Filter we were created by
    IQualityControl* m_pQSink = nullptr; // Target for Quality messages
