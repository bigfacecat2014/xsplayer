...
DEFINE_GUID(IID_ILAVAudioConfig,
...
interface __declspec(uuid("4158A22B-6553-45D0-8069-24716F8FF171")) ILAVAudioConfig : public IUnknown
{
...
extern HRESULT WINAPI LAVAudio_CreateInstance(IBaseFilter** ppObj);